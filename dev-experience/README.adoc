...
** link:https://github.com/mgunter-pivotal/pcf-workshop/blob/pro/dev-experience/Cloud_Ready_Apps.key[Cloud Ready Apps]
...
* Lets talk about about cloud ready apps and what cloud native means.
** link:https://github.com/mgunter-pivotal/pcf-workshop/blob/pro/dev-experience/PCF_Apps_Fundamentals.pptx[Running  Apps On PCF]
